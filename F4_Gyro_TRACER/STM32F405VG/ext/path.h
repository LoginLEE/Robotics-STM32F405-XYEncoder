...
Path* path_iterate1(void);
Path* path_iterate2(void);
Path* path_iterate3(void);
...
Path* gen_continuous_const_vel1(s32 vt, s32 acc);
Path* gen_continuous_const_vel2(s32 vt, s32 acc);
Path* gen_continuous_const_vel3(s32 vt, s32 acc);
